...
class Styles {
  ...
  static final TextStyle appHeader = baseTitle.copyWith(color: const Color(0xFF0e0e0e), fontSize: 36, height: 1);
  ...
  static final TextStyle cardAction =
      baseBody.copyWith(color: const Color(0xFFa6998b), fontSize: 10, height: 1, fontWeight: FontWeight.w600, letterSpacing: 0.1);
