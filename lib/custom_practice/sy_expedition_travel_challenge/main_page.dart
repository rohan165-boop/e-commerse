...
import 'package:ecommerse/custom_practice/sy_expedition_travel_challenge/leopard_page.dart';
import 'package:ecommerse/custom_practice/sy_expedition_travel_challenge/styles.dart';
    ...
    return Row(
      ...
      children: <Widget>[
        ...
        Column(
          children: <Widget>[
            Image.asset(
              isVulture ? 'assets/sytravel/vultures.png' : 'assets/sytravel/leopards.png',
              width: 28,
              height: 28,
            ),
...
class CurvePainter extends CustomPainter {
  ...
  CurvePainter({required this.animationValue, this.width});
