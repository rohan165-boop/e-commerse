...
class GuitarDrawer3dHomeScreen extends StatefulWidget {
  const GuitarDrawer3dHomeScreen({super.key});

  @override
  State<GuitarDrawer3dHomeScreen> createState() =>
      _GuitarDrawer3dHomeScreenState();
}

class _GuitarDrawer3dHomeScreenState extends State<GuitarDrawer3dHomeScreen>
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Guitar Drawer Animation"),
      ),
